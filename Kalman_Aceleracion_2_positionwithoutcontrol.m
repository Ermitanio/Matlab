...
%% Variables
Q_Process_noise_mag = 0.1;     %process noise (Q)
...
Ex = Q_Process_noise_mag^2 * [dt^5/20 dt^4/8 dt^3/6; dt^4/8 dt^3/3 dt^2/2; dt^3/6 dt^2/2 dt];     % Ex convert the process noise (stdv) into covariance matrix  
